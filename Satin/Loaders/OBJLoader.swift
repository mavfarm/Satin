...
//                    print("> Group:", readString())
    ...
    private func readMarker() -> String? {
        ...
        var result:NSString?
        scanner.scanUpToCharacters(from: .whitespaces, into: &result)
    ...
    private func readLine() -> String? {
        ...
        var result:NSString?
        scanner.scanUpToCharacters(from: .newlines, into: &result)
        return String(result ?? "")
    }
    ...
    private func readString() -> String {
        ...
        var result:NSString?
        scanner.scanUpToCharacters(from: .whitespacesAndNewlines, into: &result)
        return String(result ?? "")
    }
